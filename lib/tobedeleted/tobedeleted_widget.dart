...
import 'tobedeleted_model.dart';
export 'tobedeleted_model.dart';

class TobedeletedWidget extends StatefulWidget {
  const TobedeletedWidget({super.key});

  @override
  State<TobedeletedWidget> createState() => _TobedeletedWidgetState();
}

class _TobedeletedWidgetState extends State<TobedeletedWidget> {
  late TobedeletedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TobedeletedModel());
