...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const NavBarPage() : const Onboarding3Widget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'prof',
          path: '/prof',
          builder: (context, params) => const ProfWidget(),
        ),
        FFRoute(
          name: 'profile',
          path: '/profile',
        ...
        FFRoute(
          ...
          builder: (context, params) =>
              params.isEmpty ? const NavBarPage(initialPage: 'Study') : const StudyWidget(),
        ),
        FFRoute(
          name: 'Assignment_submit',
          path: '/assignmentSubmit',
          builder: (context, params) => const AssignmentSubmitWidget(),
        ),
        FFRoute(
          name: 'Projects',
          path: '/projects',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'Projects')
        ...
        FFRoute(
          ...
          builder: (context, params) => TaskspageWidget(
            projectRef: params.getParam('projectRef',
                ParamType.DocumentReference, false, ['Assignment']),
          ),
        ),
        FFRoute(
          name: 'WebDevelopmentClass',
          path: '/webDevelopmentClass',
          builder: (context, params) => const WebDevelopmentClassWidget(),
        ),
        FFRoute(
          name: 'HRClass',
          path: '/hRClass',
          builder: (context, params) => const HRClassWidget(),
        ),
        FFRoute(
          name: 'MarketingManagement',
          path: '/marketingManagement',
          builder: (context, params) => const MarketingManagementWidget(),
        ),
        FFRoute(
          name: 'FinanceCLass',
          path: '/financeCLass',
          builder: (context, params) => const FinanceCLassWidget(),
        ),
        FFRoute(
          name: 'DataAnalysis',
          path: '/dataAnalysis',
          builder: (context, params) => const DataAnalysisWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'Law',
          path: '/Lawclass',
          builder: (context, params) => const LawWidget(),
        ),
        FFRoute(
          name: 'ElectricalCLass',
          path: '/electricalCLass',
          builder: (context, params) => const ElectricalCLassWidget(),
        ),
        FFRoute(
          name: 'MechanicalClass',
          path: '/mechanicalClass',
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/Pink_White_Simple_Watercolor_Splash_Logo_.png',
                    fit: BoxFit.fill,
                  ),
                )
              : page;
