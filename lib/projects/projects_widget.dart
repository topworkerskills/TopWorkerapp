...
import '/components/createproject_widget.dart';
              ...
              Padding(
                ...
                child: StreamBuilder<List<AssignmentRecord>>(
                  stream: queryAssignmentRecord(
                    queryBuilder: (assignmentRecord) => assignmentRecord.where(
                      'Assignment_Student',
                  ...
                  builder: (context, snapshot) {
                    ...
                    return Column(
                      mainAxisSize: MainAxisSize.max,
                      children: List.generate(columnAssignmentRecordList.length,
                          (columnIndex) {
                              ...
                              context.pushNamed(
                                ...
                                queryParameters: {
                                  'projectRef': serializeParam(
                                    columnAssignmentRecord.reference,
