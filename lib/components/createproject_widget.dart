...
export 'createproject_model.dart';
                                          ...
                                          Padding(
                                            padding:
                                                const EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 0.0, 0.0, 8.0),
                                            child: Text(
                                              'Please enter the information below to add an Assignment.',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelMedium,
                                            ),
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          var assignmentRecordReference =
                                              AssignmentRecord.collection.doc();
                                          await assignmentRecordReference.set({
                                            ...createAssignmentRecordData(
                                              title: (_model
