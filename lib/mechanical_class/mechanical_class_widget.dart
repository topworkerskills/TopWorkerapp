...
import 'mechanical_class_model.dart';
export 'mechanical_class_model.dart';

class MechanicalClassWidget extends StatefulWidget {
  const MechanicalClassWidget({super.key});

  @override
  State<MechanicalClassWidget> createState() => _MechanicalClassWidgetState();
}

class _MechanicalClassWidgetState extends State<MechanicalClassWidget> {
  late MechanicalClassModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MechanicalClassModel());
